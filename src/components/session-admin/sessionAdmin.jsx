                ...
                <div className="col-4 border border-dark">
                    <div className="ml-3">
                        ...
                        <div className="input-group mb-3">
                            ...
                            <div className="input-group-append">
                                <button className="btn btn-outline-secondary" type="button" onClick={handleCopyToClipboard} >{btnText}</button>
                            </div>
                            
                        </div>
                    </div>
                    <div className="ml-3">
                                    <EmailShareButton subject="Emdr Eye Theraphy Seans giriş linki" url={shareUrlString} > 
                                    <EmailIcon size={32} />
                                    </EmailShareButton> 
                    ...
                    <div className="ml-3">
                        ...
                        <div className="mt-2" id="speed-slider">
                            ...
                            <div><span><label className="text-danger" style={{ fontSize: "smaller" }}><sub>*Animasyonu yeniden başlatmanız tavsiyet olunur</sub></label></span></div>
                        </div>
                        <div className="mt-2">
                            SET SHAPE
                    </div>
                        ...
                        <div className="mt-2 ml-3 mr-3" id="soundRadioGroup" onChange={(e) => dispatch(updateSession({ sound: e.target.value, _id: id }, sessionId))}>
                            <div className="row">
                                ...
                                <div>
                                    <button type="button" className="btn btn-outline-info btn-sm" onClick={() => dispatch(updateSession({ isSoundPlaying: !isSoundPlaying, _id: id }, sessionId))} ><span><Music /></span><span>{isSoundPlaying ? <Pause size={20} /> : <Play size={20} />}</span> {isSoundPlaying ? 'Off' : 'On'}</button>
                                </div>
                            </div>
